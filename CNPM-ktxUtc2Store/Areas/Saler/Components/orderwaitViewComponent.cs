...
{
    public class orderwaitViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _context;
        public orderwaitViewComponent(ApplicationDbContext dbContext)
        {
            _context = dbContext;
        }
        public IViewComponentResult Invoke()
        {
            var applicationDbContext =  _context.orders.Where(x=>x.IsDelete==false).Include(o => o.applicationUser).Include(o => o.status).ToList();
