...
{
    public class waitViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _context;
        private readonly UserManager<applicationUser> _usermanagement;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public waitViewComponent(ApplicationDbContext dbContext, UserManager<applicationUser> usermanagement, IHttpContextAccessor httpContextAccessor)
        {
            _context = dbContext;
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var order =  _context.orders.Where(x => x.applicationUserId == userId).Where(x=>x.IsDelete==true).Where(x=>x.IsComplete==false).Where(x=>x.isHuy==false).ToList();
