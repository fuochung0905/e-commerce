...
{
    public class HuyViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _context;
        private readonly UserManager<applicationUser> _usermanagement;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public HuyViewComponent(ApplicationDbContext dbContext, UserManager<applicationUser> usermanagement, IHttpContextAccessor httpContextAccessor)
        {
            _context = dbContext;
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var order =  _context.orders.Where(x => x.applicationUserId == userId).Where(x=>x.isHuy==true).ToList();
